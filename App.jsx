...
import KundliApp from "./KundliApp.jsx";
...
export default function App() {
  ...
  const [view, setView] = useState("home"); // "home" | "kundli"
    ...
    <div className="app">
      ...
      <nav className="navbar">
        ...
        <div className="nav-right">
          <button
            className={`lang-btn ${view === "kundli" ? "lang-active" : ""}`}
            onClick={() => setView(view === "kundli" ? "home" : "kundli")}
          >
            ✦ {view === "kundli" ? (lang === "hi" ? "होम" : "Home") : c.navKundli}
          </button>
